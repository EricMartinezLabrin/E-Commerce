...
urlpatterns = [
    ...
    path("products/update/<int:pk>", login_required(views.UpdateProduct.as_view()), name ="products_update"),
    path("products/delete/<int:pk>", login_required(views.ProductDelete.as_view()), name ="products_delete"),
